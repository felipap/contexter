Run ts-check and fix whatever comes up. Then commit using conventional commits. You can do one commit or multiple, depending on the content of the changes. Then push.
