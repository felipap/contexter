...
export function InfoCircleIcon({ size = 16, className }: Props) {
  return (
    <svg
      className={className}
      width={size}
...
export function WarningIcon({ size = 20, className }: Props) {
  return (
    <svg
      className={className}
      width={size}
...
export function LoadingSpinnerIcon({ size = 12, className }: Props) {
  return (
    <svg
      className={className}
      width={size}
...
export function ScreenCaptureIcon({ size = 18, className }: Props) {
  return (
    <svg
      className={className}
      width={size}
...
export function IMessageIcon({ size = 18, className }: Props) {
  return (
    <svg
      className={className}
      width={size}
...
export function ContactsIcon({ size = 18, className }: Props) {
  return (
    <svg
      className={className}
      width={size}
...
export function AppleRemindersIcon({ size = 18, className }: Props) {
  return (
    <svg
      className={className}
      width={size}
...
export function AppleNotesIcon({ size = 18, className }: Props) {
  return (
    <svg
      className={className}
      width={size}
