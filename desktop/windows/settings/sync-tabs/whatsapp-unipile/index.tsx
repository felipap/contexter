...
export const WhatsappUnipileSyncTab = withBoundary(
  function WhatsappUnipileSyncTab({ onEnabledChange, highlightSyncId }: Props) {
    ...
    const handleIntervalChange = async (minutes: number) => {
      ...
      await window.electron.setWhatsappUnipileConfig({
